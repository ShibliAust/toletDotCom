...
namespace TOLET4
{
    public partial class femaleMess : System.Web.UI.Page
    {
        ...
        public void init(String tmp, String lt )
        {
            ...
            obj.execute_query("residentialhouse", "Female Mess", tmp , lt );

        }

        protected void d_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/femaleMess.aspx?idd=date");
        }

        protected void r_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/femaleMess.aspx?idd=rent");
        }

        protected void search_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/femaleMess.aspx?idd=bed" + bed.Items[bed.SelectedIndex].Text);
        }
