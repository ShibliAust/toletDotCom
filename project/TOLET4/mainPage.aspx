<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mainPage.aspx.cs" Inherits="TOLET4.mainPage" %>
      ...
      <div id="catlist">
        ...
        <div class="row">
            ...
            <ul class="pagination" style="margin-left:330px;"> 
                ...
                <li class=<%=jole[1]%>><a href="mainPage.aspx?id=1">1</a></li>
                <li class=<%=jole[2]%>><a href="mainPage.aspx?id=2">2</a></li>
                <li class=<%=jole[3]%>><a href="mainPage.aspx?id=3">3</a></li>
                <li class=<%=jole[4]%>><a href="mainPage.aspx?id=4">4</a></li>
                <li class=<%=jole[5]%>><a href="mainPage.aspx?id=5">5</a></li>
                <li class=<%=jole[6]%>><a href="mainPage.aspx?id=6">6</a></li>
                <li class=<%=jole[7]%>><a href="mainPage.aspx?id=7">7</a></li>
                <li class=<%=jole[8]%>><a href="mainPage.aspx?id=8">8</a></li>
                <li class=<%=jole[9]%>><a href="mainPage.aspx?id=9">9</a></li>
                <li class=<%=jole[10]%>><a href="mainPage.aspx?id=10">10</a></li>
                <li class=<%=jole[11]%>><a href="mainPage.aspx?id=11">11</a></li>
                <li class=<%=jole[12]%>><a href="mainPage.aspx?id=12">12</a></li>
