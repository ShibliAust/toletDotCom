    ...
    <div class="container">    
     ...
     <div class="row">
      ...
      <div id="catlist">
            ...
            <!--First list start-->
            <dl>
		        <dt><img src=<%=image[1]%> alt="Unavailable" width="93" height="62" /><strong><%=rent[1] %></strong><a href=<%=post[1] %>><%=head[1] %></a></dt>
            ...
            <!--Second list start-->       
	        <dl>
		        <dt><img src=<%=image[2]%> alt="Unavailable" width="93" height="62" /><strong><%=rent[2] %></strong><a href=<%=post[2] %>><%=head[2]%></a></dt>
		        <dd>
			        <p><%=description[2] %></p>
		        </dd>
	        </dl>
            ...
            <!--Third list start-->       
	        <dl>
		        <dt><img src=<%=image[3]%> alt="Unavailable" width="93" height="62" /><strong><%=rent[3] %></strong><a href=<%=post[3] %>><%=head[3] %></a></dt>
		        <dd>
			        <p><%=description[3]%></p>
		        </dd>
	        </dl>
            ...
            <!--Fourth list start-->      
	        <dl>
		        <dt><img src=<%=image[4]%> alt="Unavailable" width="93" height="62" /><strong><%=rent[4] %></strong><a href=<%=post[4] %>><%=head[4] %></a></dt>
		        <dd>
			        <p><%=description[4]%></p>
		        </dd>
	        </dl>
            ...
            <!--Fifth list start-->       
	        <dl>
		        <dt><img src=<%=image[5]%> alt="Unavailable" width="93" height="62" /><strong><%=rent[5] %></strong><a href=<%=post[5] %>><%=head[5] %></a></dt>
		        <dd>
			        <p><%=description[5]%></p>
		        </dd>
	        </dl>
