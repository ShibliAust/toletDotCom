<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commercialSpace.aspx.cs" Inherits="TOLET4.commercialSpace" %>
             ...
             <form class="well form-horizontal" action=" " method="post"  id="form1" runat="server">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">Address</label>  
                    ...
                    <asp:TextBox ID="address" placeholder="Address of the space" class="form-control"  type="text" runat="server"></asp:TextBox>
                    </div>
                  </div>
                </div>
