<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="allUser.aspx.cs" Inherits="TOLET4.allUser" %>
    ...
    <div class="container">    
     ...
     <div class="row">
      ...
      <!-- RECENTLY POSTED ADS start-->
         ...
         <h1 class="page-header">All User List <small>Admin</small></h1>
      ...
      <div id="catlist">
            ...
            <!--First list start-->
            <dl>
		        <dt><strong><%=obj.contact[1] %></strong><%=obj.name[1] %></dt>
            ...
            <!--Second list start-->       
	        <dl>
		        <dt><strong><%=obj.contact[2] %></strong><%=obj.name[2] %></dt>
          ...
          <asp:Button ID="delete2" class="btn btn-primary pull-right" runat="server" Text="Delete" OnClick="delete2_Click"/>
            ...
            <!--Third list start-->       
	        <dl>
		        <dt><strong><%=obj.contact[3] %></strong><%=obj.name[3] %></dt>
          ...
          <asp:Button ID="delete3" class="btn btn-primary pull-right" runat="server" Text="Delete" OnClick="delete3_Click" />
            ...
            <!--Fourth list start-->      
	        <dl>
		        <dt><strong><%=obj.contact[4] %></strong><%=obj.name[4] %></dt>
          ...
          <asp:Button ID="delete4" class="btn btn-primary pull-right" runat="server" Text="Delete" OnClick="delete4_Click" />
            ...
            <!--Fifth list start-->       
	        <dl>
		        <dt><strong><%=obj.contact[5] %></strong><%=obj.name[5] %></dt>
        ...
        <div class="row">
            ...
            <ul class="pagination" style="margin-left:330px;"> 
                ...
                <li class=<%=jole[1]%>><a href="allUser.aspx?id=1">1</a></li>
                <li class=<%=jole[2]%>><a href="allUser.aspx?id=2">2</a></li>
                <li class=<%=jole[3]%>><a href="allUser.aspx?id=3">3</a></li>
                <li class=<%=jole[4]%>><a href="allUser.aspx?id=4">4</a></li>
                <li class=<%=jole[5]%>><a href="allUser.aspx?id=5">5</a></li>
                <li class=<%=jole[6]%>><a href="allUser.aspx?id=6">6</a></li>
                <li class=<%=jole[7]%>><a href="allUser.aspx?id=7">7</a></li>
                <li class=<%=jole[8]%>><a href="allUser.aspx?id=8">8</a></li>
                <li class=<%=jole[9]%>><a href="allUser.aspx?id=9">9</a></li>
                <li class=<%=jole[10]%>><a href="allUser.aspx?id=10">10</a></li>
                <li class=<%=jole[11]%>><a href="allUser.aspx?id=11">11</a></li>
                <li class=<%=jole[12]%>><a href="allUser.aspx?id=12">12</a></li>
