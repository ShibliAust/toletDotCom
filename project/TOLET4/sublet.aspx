<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sublet.aspx.cs" Inherits="TOLET4.sublet" %>
<!DOCTYPE html>
...
<body>
    ...
    <!-- CATEGORY OPTION BUTTONS start-->
     ...
     <div>
                ...
                <asp:Button ID="d" class="btn btn-danger" runat="server" Text="Date" style="position:absolute;left:650px;top:325px; right: 323px;" OnClick="d_Click"></asp:Button>
                ...
                <h4><p style="position:absolute;left:790px;top:330px;font:medium">Bedroom:</p></h4>
                
              <div class="form-group" style="position:absolute;left:880px;top:325px;">                
                ...
                <asp:Button ID="search" class="btn btn-danger" runat="server" Text="Search" style="position:absolute;left:950px;top:325px;" OnClick="search_Click"></asp:Button>
       ...
       <!-- PAGINATION START -->
        <div class="row">
            ...
            <ul class="pagination" style="margin-left:330px;"> 
                ...
                <li class=<%=jole[1]%>><a href="sublet.aspx?id=1">1</a></li>
                <li class=<%=jole[2]%>><a href="sublet.aspx?id=2">2</a></li>
                <li class=<%=jole[3]%>><a href="sublet.aspx?id=3">3</a></li>
                <li class=<%=jole[4]%>><a href="sublet.aspx?id=4">4</a></li>
                <li class=<%=jole[5]%>><a href="sublet.aspx?id=5">5</a></li>
                <li class=<%=jole[6]%>><a href="sublet.aspx?id=6">6</a></li>
                <li class=<%=jole[7]%>><a href="sublet.aspx?id=7">7</a></li>
                <li class=<%=jole[8]%>><a href="sublet.aspx?id=8">8</a></li>
                <li class=<%=jole[9]%>><a href="sublet.aspx?id=9">9</a></li>
                <li class=<%=jole[10]%>><a href="sublet.aspx?id=10">10</a></li>
                <li class=<%=jole[11]%>><a href="sublet.aspx?id=11">11</a></li>
                <li class=<%=jole[12]%>><a href="sublet.aspx?id=12">12</a></li>
