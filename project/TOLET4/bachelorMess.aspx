<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bachelorMess.aspx.cs" Inherits="TOLET4.bachelorMess" %>
...
<body>
    ...
    <div class="container">    
     ...
     <div>
                <h4><p style="position:absolute;left:665px;top:330px;font:medium">Sort By:</p></h4>

                <asp:Button ID="d" class="btn btn-danger" runat="server" Text="Date" style="position:absolute;left:750px;top:325px; right: 323px;" OnClick="d_Click"></asp:Button>
                <asp:Button ID="r" class="btn btn-danger" runat="server" Text="Rent" style="position:absolute;left:810px;top:325px; right: 263px;" OnClick="r_Click"></asp:Button>
                <h4><p style="position:absolute;left:890px;top:330px;font:medium">Bedroom:</p></h4>
                
              <div class="form-group" style="position:absolute;left:980px;top:325px;">                
                    <div class="inputGroupContainer">
                         <select class="form-control" runat="server" id="bed">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                ...
                <asp:Button ID="search" class="btn btn-danger" runat="server" Text="Search" style="position:absolute;left:1050px;top:325px;" OnClick="search_Click"></asp:Button>
      ...
      <div id="catlist">
        ...
        <div class="row">
            ...
            <ul class="pagination" style="margin-left:330px;"> 
                ...
                <li class=<%=jole[1]%>><a href="bachelorMess.aspx?id=1">1</a></li>
                <li class=<%=jole[2]%>><a href="bachelorMess.aspx?id=2">2</a></li>
                <li class=<%=jole[3]%>><a href="bachelorMess.aspx?id=3">3</a></li>
                <li class=<%=jole[4]%>><a href="bachelorMess.aspx?id=4">4</a></li>
                <li class=<%=jole[5]%>><a href="bachelorMess.aspx?id=5">5</a></li>
                <li class=<%=jole[6]%>><a href="bachelorMess.aspx?id=6">6</a></li>
                <li class=<%=jole[7]%>><a href="bachelorMess.aspx?id=7">7</a></li>
                <li class=<%=jole[8]%>><a href="bachelorMess.aspx?id=8">8</a></li>
                <li class=<%=jole[9]%>><a href="bachelorMess.aspx?id=9">9</a></li>
                <li class=<%=jole[10]%>><a href="bachelorMess.aspx?id=10">10</a></li>
                <li class=<%=jole[11]%>><a href="bachelorMess.aspx?id=11">11</a></li>
                <li class=<%=jole[12]%>><a href="bachelorMess.aspx?id=12">12</a></li>
