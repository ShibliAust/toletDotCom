<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myPost.aspx.cs" Inherits="TOLET4.myPost" %>
    ...
    <div class="container">    
     ...
     <div class="row">
      ...
      <div id="catlist">
            ...
            <asp:Button ID="delete1" class="btn btn-primary pull-right" runat="server" Text="Delete" OnClick="delete1_Click1" />
        ...
        <div class="row">
            ...
            <ul class="pagination" style="margin-left:330px;"> 
                ...
                <li class=<%=jole[1]%>><a href="myPost.aspx?id=1">1</a></li>
                <li class=<%=jole[2]%>><a href="myPost.aspx?id=2">2</a></li>
                <li class=<%=jole[3]%>><a href="myPost.aspx?id=3">3</a></li>
                <li class=<%=jole[4]%>><a href="myPost.aspx?id=4">4</a></li>
                <li class=<%=jole[5]%>><a href="myPost.aspx?id=5">5</a></li>
                <li class=<%=jole[6]%>><a href="myPost.aspx?id=6">6</a></li>
                <li class=<%=jole[7]%>><a href="myPost.aspx?id=7">7</a></li>
                <li class=<%=jole[8]%>><a href="myPost.aspx?id=8">8</a></li>
                <li class=<%=jole[9]%>><a href="myPost.aspx?id=9">9</a></li>
                <li class=<%=jole[10]%>><a href="myPost.aspx?id=10">10</a></li>
                <li class=<%=jole[11]%>><a href="myPost.aspx?id=11">11</a></li>
                <li class=<%=jole[12]%>><a href="myPost.aspx?id=12">12</a></li>
