...
namespace TOLET4
{
    public partial class bachelorMess : System.Web.UI.Page
    {
        ...
        public void init(String tmp , String lt)
        {
            ...
            obj.execute_query("residentialhouse", "Bachelor Mess", tmp, lt );

        }

        protected void d_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/bachelorMess.aspx?idd=date");
        }

        protected void r_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/bachelorMess.aspx?idd=rent");
        }

        protected void search_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/bachelorMess.aspx?idd=bed" + bed.Items[bed.SelectedIndex].Text);
        }
