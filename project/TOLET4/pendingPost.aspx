<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pendingPost.aspx.cs" Inherits="TOLET4.pendingPost" %>
    ...
    <div class="container">    
     ...
     <div class="row">
      ...
      <!-- RECENTLY POSTED ADS start-->
         ...
         <h1 class="page-header">Pending Posts <small>Admin</small></h1>
      ...
      <div id="catlist">
           ...
           <asp:Button ID="app1" class="btn btn-primary pull-right" runat="server" Text="Approve" OnClick="app1_Click"/>
          ...
          <asp:Button ID="app2" class="btn btn-primary pull-right" runat="server" Text="Approve" OnClick="app2_Click"/>
          ...
          <asp:Button ID="app3" class="btn btn-primary pull-right" runat="server" Text="Approve" OnClick="app3_Click"/>
          ...
          <asp:Button ID="app4" class="btn btn-primary pull-right" runat="server" Text="Approve" OnClick="app4_Click"/>
          ...
          <asp:Button ID="app5" class="btn btn-primary pull-right" runat="server" Text="Approve" OnClick="app5_Click"/>
        ...
        <div class="row">
            ...
            <ul class="pagination" style="margin-left:330px;"> 
                ...
                <li class=<%=jole[1]%>><a href="pendingPost.aspx?id=1">1</a></li>
                <li class=<%=jole[2]%>><a href="pendingPost.aspx?id=2">2</a></li>
                <li class=<%=jole[3]%>><a href="pendingPost.aspx?id=3">3</a></li>
                <li class=<%=jole[4]%>><a href="pendingPost.aspx?id=4">4</a></li>
                <li class=<%=jole[5]%>><a href="pendingPost.aspx?id=5">5</a></li>
                <li class=<%=jole[6]%>><a href="pendingPost.aspx?id=6">6</a></li>
                <li class=<%=jole[7]%>><a href="pendingPost.aspx?id=7">7</a></li>
                <li class=<%=jole[8]%>><a href="pendingPost.aspx?id=8">8</a></li>
                <li class=<%=jole[9]%>><a href="pendingPost.aspx?id=9">9</a></li>
                <li class=<%=jole[10]%>><a href="pendingPost.aspx?id=10">10</a></li>
                <li class=<%=jole[11]%>><a href="pendingPost.aspx?id=11">11</a></li>
                <li class=<%=jole[12]%>><a href="pendingPost.aspx?id=12">12</a></li>
